...
},{"isomorphic-fetch":7}],19:[function(require,module,exports){
'use strict';
...
var Directory = function (_Base) {
  ...
  _createClass(Directory, [{
    key: 'fetchAll',
    value: function fetchAll(opts) {
      var _this2 = this;

      var path = this._path;
      return this._nuxeo.request(path).httpTimeout(this._httpTimeout).transactionTimeout(this._transactionTimeout).get(opts).then(function (res) {
        var entries = res.entries.map(function (entry) {
          return new _entry2.default(entry, {
            nuxeo: _this2._nuxeo,
            directory: _this2
          });
        });
    ...
    value: function fetch(id, opts) {
      ...
      return this._nuxeo.request(path).headers(this._headers).timeout(this._timeout).httpTimeout(this._httpTimeout).transactionTimeout(this._transactionTimeout).get(opts).then(function (res) {
        return new _entry2.default(res, {
          nuxeo: _this3._nuxeo,
          directory: _this3
        });
      });
    ...
    value: function create(entry) {
      ...
      var path = this._path;
      return this._nuxeo.request(path).headers(this._headers).timeout(this._timeout).httpTimeout(this._httpTimeout).transactionTimeout(this._transactionTimeout).post(opts).then(function (res) {
        return new _entry2.default(res, {
          nuxeo: _this4._nuxeo,
          directory: _this4
        });
...
},{"../base":15,"../deps/utils/join":23,"./entry":25}],25:[function(require,module,exports){
'use strict';
...
},{"extend":4}],26:[function(require,module,exports){
'use strict';
...
},{"./deps/utils/join":23,"extend":4}],27:[function(require,module,exports){
'use strict';
...
},{"extend":4}],28:[function(require,module,exports){
'use strict';
...
},{"../base":15,"../deps/utils/join":23,"./group":27}],29:[function(require,module,exports){
'use strict';
...
},{"./base":15,"./blob":16,"./deps/promise":20,"./directory/directory":24,"./directory/entry":25,"./document":26,"./group/group":27,"./group/groups":28,"./nuxeo":30,"./operation":31,"./repository":32,"./request":33,"./upload/batch":34,"./upload/blob":35,"./user/user":36,"./user/users":37}],30:[function(require,module,exports){
'use strict';
...
},{"./base":15,"./deps/auth":17,"./deps/fetch":18,"./deps/form-data":19,"./deps/promise":20,"./deps/utils/join":23,"./directory/directory":24,"./group/groups":28,"./operation":31,"./repository":32,"./request":33,"./upload/batch":34,"./user/users":37,"extend":4,"query-string":12}],31:[function(require,module,exports){
'use strict';
...
},{"./base":15,"./blob":16,"./deps/form-data":19,"./deps/utils/join":23,"./upload/batch":34,"./upload/blob":35,"extend":4}],32:[function(require,module,exports){
'use strict';
...
},{"./base":15,"./deps/utils/join":23,"./document":26}],33:[function(require,module,exports){
'use strict';
...
},{"./base":15,"./deps/utils/join":23,"extend":4}],34:[function(require,module,exports){
'use strict';
...
var BatchUpload = function (_Base) {
  ...
  _createClass(BatchUpload, [{
    ...
    value: function _fetchBatchId() {
      ...
      return this._nuxeo.fetch(opts).then(function (res) {
    ...
    value: function cancel(opts) {
      ...
      return this._batchIdPromise.then(function () {
        return _this6._nuxeo.request(path).timeout(_this6._timeout).httpTimeout(_this6._httpTimeout).transactionTimeout(_this6._transactionTimeout).delete(opts);
      }).then(function () {
    ...
    value: function fetchBlob(index, opts) {
      ...
      return this._nuxeo.fetch(finalOptions).then(function (res) {
    ...
    value: function fetchBlobs(opts) {
      ...
      this._nuxeo.fetch(finalOptions).then(function (blobs) {
...
},{"../base":15,"../deps/utils/join":23,"./blob":35,"extend":4,"promise-queue":9}],35:[function(require,module,exports){
'use strict';
...
},{"extend":4}],36:[function(require,module,exports){
'use strict';
...
},{"extend":4}],37:[function(require,module,exports){
'use strict';
...
},{"../base":15,"../deps/utils/join":23,"./user":36}]},{},[29])(29)
});