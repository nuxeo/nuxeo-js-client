...
},{"./utils/base64":22}],18:[function(require,module,exports){
'use strict';
...
},{"./auth":17,"./form-data":19,"./promise-nuxeo":21,"extend":4,"isomorphic-fetch":7,"query-string":12}],19:[function(require,module,exports){
'use strict';
...
},{"../nuxeo":27}],22:[function(require,module,exports){
'use strict';
...
},{"./base":15,"./blob":16,"./deps/promise":20,"./document":25,"./nuxeo":27,"./operation":28,"./repository":29,"./request":30,"./upload/batch":31,"./upload/blob":32}],27:[function(require,module,exports){
'use strict';
...
},{"./base":15,"./deps/fetch":18,"./deps/utils/join":24,"./operation":28,"./repository":29,"./request":30,"./upload/batch":31,"extend":4}],28:[function(require,module,exports){
'use strict';
...
},{"./base":15,"./blob":16,"./deps/fetch":18,"./deps/form-data":19,"./deps/utils/join":24,"./upload/batch":31,"./upload/blob":32,"extend":4}],29:[function(require,module,exports){
'use strict';
...
var _promiseNuxeo = require('./deps/promise-nuxeo');
  ...
  _createClass(Repository, [{
    ...
    value: function fetch(ref, opts) {
      ...
      return (0, _promiseNuxeo2.default)(function (resolve, reject) {
        ...
        _this2._nuxeo.request(path).repositoryName(_this2._repositoryName).schemas(_this2._schemas).headers(_this2._headers).timeout(_this2._timeout).httpTimeout(_this2._httpTimeout).transactionTimeout(_this2._transactionTimeout).get(opts).then(function (doc) {
    ...
    value: function create(parentRef, doc) {
      ...
      return (0, _promiseNuxeo2.default)(function (resolve, reject) {
        ...
        _this3._nuxeo.request(path).repositoryName(_this3._repositoryName).schemas(_this3._schemas).headers(_this3._headers).timeout(_this3._timeout).httpTimeout(_this3._httpTimeout).transactionTimeout(_this3._transactionTimeout).post(opts).then(function (res) {
    ...
    value: function update(doc) {
      ...
      return (0, _promiseNuxeo2.default)(function (resolve, reject) {
        ...
        _this4._nuxeo.request(path).repositoryName(_this4._repositoryName).schemas(_this4._schemas).headers(_this4._headers).timeout(_this4._timeout).httpTimeout(_this4._httpTimeout).transactionTimeout(_this4._transactionTimeout).put(opts).then(function (res) {
          return resolve(new _document2.default(res, {
            nuxeo: _this4._nuxeo,
            repository: _this4,
...
},{"./base":15,"./deps/promise-nuxeo":21,"./deps/utils/join":24,"./document":25}],30:[function(require,module,exports){
'use strict';
...
},{"./base":15,"./deps/fetch":18,"./deps/utils/join":24,"extend":4}],31:[function(require,module,exports){
'use strict';
...
var BatchUpload = function (_Base) {
  ...
  _createClass(BatchUpload, [{
    ...
    value: function upload() {
      ...
      return (0, _promiseNuxeo2.default)(function (resolve, reject) {
        Promise.all(promises).then(function (batchBlobs) {
          return resolve({
            blobs: batchBlobs,
            batch: _this2
          });
    ...
    value: function done() {
      ...
      return (0, _promiseNuxeo2.default)(function (resolve, reject) {
        Promise.all(_this5._promises).then(function (batchBlobs) {
          return resolve({
            blobs: batchBlobs,
            batch: _this5
          });
    ...
    value: function cancel(opts) {
      ...
      return (0, _promiseNuxeo2.default)(function (resolve, reject) {
        ...
        _this6._batchIdPromise.then(function () {
          _this6._nuxeo.request(path).timeout(_this6._timeout).httpTimeout(_this6._httpTimeout).transactionTimeout(_this6._transactionTimeout).delete(opts).then(function () {
...
},{"../base":15,"../deps/fetch":18,"../deps/promise-nuxeo":21,"../deps/utils/join":24,"./blob":32,"extend":4,"promise-queue":9}],32:[function(require,module,exports){
'use strict';
