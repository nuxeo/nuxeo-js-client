...
Check out the [API documentation](https://nuxeo.github.io/nuxeo-js-client/4.0.6/).
...
See the [ServerVersion](https://nuxeo.github.io/nuxeo-js-client/4.0.6/ServerVersion.html) documentation.
...
See the [Operation](https://nuxeo.github.io/nuxeo-js-client/4.0.6/Operation.html) documentation.
...
See the [Request](https://nuxeo.github.io/nuxeo-js-client/4.0.6/Request.html) documentation.
...
See the [Repository](https://nuxeo.github.io/nuxeo-js-client/4.0.6/Repository.html) documentation.
...
See the [Document](https://nuxeo.github.io/nuxeo-js-client/4.0.6/Document.html) documentation.
...
See the [BatchUpload](https://nuxeo.github.io/nuxeo-js-client/4.0.6/BatchUpload.html) documentation.
...
See the [Users](https://nuxeo.github.io/nuxeo-js-client/4.0.6/Users.html) and
[User](https://nuxeo.github.io/nuxeo-js-client/4.0.6/User.html) documentation.
...
See the [Groups](https://nuxeo.github.io/nuxeo-js-client/4.0.6/Groups.html) and
[Group](https://nuxeo.github.io/nuxeo-js-client/4.0.6/Group.html) documentation.
...
See the [Directory](https://nuxeo.github.io/nuxeo-js-client/4.0.6/Directory.html) and
[DirectoryEntry](https://nuxeo.github.io/nuxeo-js-client/4.0.6/DirectoryEntry.html) documentation.
