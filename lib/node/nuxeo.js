...
var DEFAULT_PROXY_AUTH_HEADER_NAME = 'Auth-User';
...
Client.prototype._initAuthentication = function() {
  if (this._authentication.method === 'proxy') {
    var proxyAuthHeaderName = this._authentication.proxyAuthHeaderName || DEFAULT_PROXY_AUTH_HEADER;
