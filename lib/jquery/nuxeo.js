var nuxeo = (function(nuxeo) {
  ...
  Client.prototype._initAuthentication = function() {
    switch (this._authentication.method) {
      case 'basic':
        if (this._authentication.username && this._authentication.password) {
          this._headers['Authorization'] = 'Basic ' + btoa(this._authentication.username + ':' + this._authentication.password);
          this._xhrFields = {
